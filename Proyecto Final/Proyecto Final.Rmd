...
inglesa_final$Pandemic = ifelse((inglesa_final$Date > "2020-03-11" & inglesa_final$Date < "2020-12-02") | (inglesa_final$Date >= "2020-12-14" & inglesa_final$Date <= "2021-05-17"), "Sí", "No")
...
inglesa_final$HomeTeamSize = ifelse((inglesa_final$HomeTeam == "Man United" | inglesa_final$HomeTeam == "Liverpool"| inglesa_final$HomeTeam == "Chelsea"| inglesa_final$HomeTeam == "Tottenham"| inglesa_final$HomeTeam == "Arsenal"| inglesa_final$HomeTeam == "Everton"| inglesa_final$HomeTeam == "Leicester"| inglesa_final$HomeTeam == "Wolves"| inglesa_final$HomeTeam == "Aston Villa"), "Grande", "Pequeño")

inglesa_final$AwayTeamSize = ifelse((inglesa_final$AwayTeam == "Man United" | inglesa_final$AwayTeam == "Liverpool"| inglesa_final$AwayTeam == "Chelsea"| inglesa_final$AwayTeam == "Tottenham"| inglesa_final$AwayTeam == "Arsenal"| inglesa_final$AwayTeam == "Everton"| inglesa_final$AwayTeam == "Leicester"| inglesa_final$AwayTeam == "Wolves"| inglesa_final$AwayTeam == "Aston Villa"), "Grande", "Pequeño")
