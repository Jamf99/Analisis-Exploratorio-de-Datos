...
Solamente tendremos en cuenta los equipos que jugaron de local, puesto que esta es nuestra variable de interés, se necesita observar cómo es el patrón del rendimiento a inicios, durante y después de la pandemia.
...
Para todas las variables, no se encontraron anomalías de tipo *Formato de las variables no coincide con su tipo de variable*

Se procederá a analizar variable por variable en busca de cualquier tipo de anomalía:
